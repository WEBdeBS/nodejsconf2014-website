...
<!--[if gt IE 9]><!--> <html class=""> <!--<![endif]-->
	...
	<body>
		...
		<div class="mostro-box">
			...
			<div id="lr-widget" rel="MTBE93HI" style="display:none;"> </div>
			<script type="text/javascript" src="//ignition.launchrock.com/ignition-current.min.js"></script>
			<!-- End LaunchRock Widget -->

			<div id="lr-widget">
				<div class="LR-box" style="text-align:center; background: none;">
					<a href="https://www.eventbrite.it/e/biglietti-nodejs-conf-it-2014-9509179211?ref=ebtn" target="_blank"><img src="https://www.eventbrite.it/custombutton?eid=9509179211" alt="Eventbrite - NodeJS Conf It 2014" /></a>
				</div>
			</div>
